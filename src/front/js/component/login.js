...
export const Login = () => {
  ...
  return (
    <div>
      <button
        className=" block text-white titlecomponent  focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        type="button"
      ...
      >
        <div className="relative p-4 mx-auto mt-32 w-full max-w-md h-full md:h-auto">
